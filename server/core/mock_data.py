"""
mock_data.py — Mock Data Layer for the SOC Agent
...
def mock_virustotal_scan(filename: str) -> dict:
    ...
    """
    return _MOCK_VT_DATABASE.get(filename, _DEFAULT_VT)
...
# Report writes to project root
REPORT_OUTPUT_PATH = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "incident_report.json"
)
